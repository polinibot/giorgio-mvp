...
# --- TEMPORARY: Admin endpoint for seeding test practices ---
@app.post("/admin/seed-test-practices")
async def seed_test_practices(
    request: Request,
    secret: str = Header(..., alias="X-Admin-Secret"),
    db: Session = Depends(get_db),
):
    """Temporary endpoint to seed test practices. Requires admin secret."""
    ADMIN_SECRET = os.getenv("ADMIN_SEED_SECRET", "giorgio-seed-2026")
    ...
    test_practices = [
        {
            ...
            "time": "09:00",
            "sections": [{"context": Context.OFFICINA, "description_rows": ["Cambio olio", "Controllo freni", "Verifica livelli"], "man_hours": 1.5, "mac_hours": 0.5, "materials_amount": 50.0}]
        },
        {
            "plate": "TEST02BB",
            ...
            "time": "10:30",
            "sections": [{"context": Context.CARROZZERIA, "description_rows": ["Riparazione paraurti anteriore", "Sverniciatura e riverniciatura"], "man_hours": 3.0, "mac_hours": 1.0, "materials_amount": 150.0}]
        },
        {
            "plate": "TEST03CC",
            ...
            "time": "14:00",
            "sections": [{"context": Context.REVISIONE, "description_rows": ["Revisione periodica", "Controllo emissioni", "Verifica pneumatici"], "man_hours": 2.0, "mac_hours": 0.5, "materials_amount": 30.0}]
        },
        {
            "plate": "TEST04DD",
            ...
            "time": "15:30",
            "sections": [
                {"context": Context.OFFICINA, "description_rows": ["Cambio batteria", "Controllo alternatore"], "man_hours": 1.0, "mac_hours": 0.3, "materials_amount": 80.0},
                {"context": Context.CARROZZERIA, "description_rows": ["Toccatura portiera sinistra"], "man_hours": 1.5, "mac_hours": 0.5, "materials_amount": 40.0}
            ]
        },
        {
            "plate": "TEST05EE",
            ...
            "contexts": [Context.OFFICINA],
            "time": "16:00",
            "sections": [{"context": Context.OFFICINA, "description_rows": ["Sostituzione filtri aria e abitacolo", "Controllo climatizzatore"], "man_hours": 0.8, "mac_hours": 0.2, "materials_amount": 25.0}]
        },
        {
            "plate": "TEST06FF",
            ...
            "contexts": [Context.CARROZZERIA],
            "time": "17:00",
            "sections": [{"context": Context.CARROZZERIA, "description_rows": ["Riparazione cofano", "Lucidatura completa"], "man_hours": 4.0, "mac_hours": 1.5, "materials_amount": 200.0}]
        }
    ]
    
    created = []
    for practice_data in test_practices:
        practice = Practice(
        ...
        created.append({"id": practice.id, "plate": practice_data["plate"], "customer": practice_data["customer"]})
    
    db.commit()
    return APIResponse(success=True, data={"created": created, "total": len(created)})
